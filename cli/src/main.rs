...
use reqlang::assert_response::ResponseDiff;
use reqlang::{
                    ...
                    if is_testing_response {
                        ...
                        if let Some(expected_response) = &reqfile.response {
                            ...
                            if let Err(diffs) = assert_response(expected_response, response) {
                                ...
                                for response_diff in diffs.iter() {
                                    match response_diff {
                                ...
                                let first_line_diff: Option<(String, String)> =
                                    match (http_version_diff, status_code_diff, status_text_diff) {
                                        ...
                                        (
                                            ...
                                            format!(
                                                "HTTP/{} {} {}",
                                                expected_response.http_version,
